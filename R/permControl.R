`permControl`<- function(cm=NULL,nmc=10^3-1,seed=1234321,digits=12,p.conf.level=.99,setSEED=TRUE){
    ...
    list(cm=cm,nmc=nmc,seed=seed,digits=digits,p.conf.level=p.conf.level,setSEED=setSEED)    
}
